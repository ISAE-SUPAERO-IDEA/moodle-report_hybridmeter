...
class indicator {
    ...
    public static function hybridation_calculus(string $type, array $activity_data): float {
        ...
        if($sigma_pk != 0){
            ...
            $h = $m * $p * $sigma_pk_vk / $sigmaPk;
        }
        return round($h, 2);
    }

    public static function digitalisation_level(array $object, array $parameters): float {
        $activity_data = data_provider::get_instance()->count_activities_per_type_of_course($object['id']);
        return self::hybridation_calculus("digitalisation_coeffs", $activity_data);
    }

    public static function raw_data(array $object, array $parameters) {
        return data_provider::get_instance()->count_activities_per_type_of_course($object['id']);
    }


    public static function usage_level(array $object, array $parameters): float {
        ...
        return self::hybridation_calculus("usage_coeffs", $activity_data);
    }

    public static function get_category_path(array $object, array $parameters): string {
    ...
    public static function is_course_active_last_month(array $object, array $parameters): bool {
        $configurator = configurator::get_instance();
    ...
    public static function active_students (array $object, array $parameters): int {
        $configurator = configurator::get_instance();
    ...
    public static function nb_registered_students (array $object, array $parameters): int {
